...
VENDOR_PATH := device/huawei/victoria
...
TARGET_PREBUILT_KERNEL := device/huawei/victoria/kernel/dummykernel

# Properties
BOARD_PROPERTY_OVERRIDES_SPLIT_ENABLED := true
TARGET_SYSTEM_PROP := device/huawei/victoria/system.prop
